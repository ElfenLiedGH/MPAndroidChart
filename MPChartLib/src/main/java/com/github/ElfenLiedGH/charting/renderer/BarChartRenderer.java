...
package com.github.ElfenLiedGH.charting.renderer;
...
import com.github.ElfenLiedGH.charting.buffer.BarBuffer;
...
import com.github.ElfenLiedGH.charting.highlight.Range;
import com.github.ElfenLiedGH.charting.interfaces.dataprovider.BarDataProvider;
...
import com.github.ElfenLiedGH.charting.utils.Fill;
...
public class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    @Override
    public void drawValues(Canvas c, DrawnLabels drawnValues) {
        // if values are drawn
                ...
                if (!dataSet.isStacked()) {
                    ...
                    for (int j = 0; j < buffer.buffer.length * mAnimator.getPhaseX(); j += 4) {
                        ...
                        if (dataSet.isDrawValuesEnabled()) {
                            ...
                            float[] point = drawnValues.add(x, y);

                            drawValue(c, dataSet.getValueFormatter(), val, entry, i, point[0],
                                    point[1],
                    ...
                    while (index < dataSet.getEntryCount() * mAnimator.getPhaseX()) {
                        ...
                        if (vals == null) {
                            ...
                            if (dataSet.isDrawValuesEnabled()) {
                                ...
                                float[] point = drawnValues.add(x, y);
                                drawValue(c, dataSet.getValueFormatter(), entry.getY(), entry, i, point[0],
                                        point[1],
                                        color);
                            }
